...
exports.import = function (cells, vds, config) {
	...
	cells = fs.readFileSync(cells, 'utf8');
	...
	vds.forEach(function (entry) {
		...
		if ((i0 < 0) || (i1 >= indexEnd)) console.error('Außerhalb des Zeitintervalls');
	...
	function setCell(index, cellId) {
		...
		if (positions[index] === undefined) {
			positions[index] = {
				index: index,
				time: index*timeInterval + timeStart,
				cells: {}
			}
		}
		positions[index].cells[cellId] = true;
	}
