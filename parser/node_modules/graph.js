...
exports.Graph = function () {
	...
	me.updateEvents = function (events) {
		...
		contacts.push({label: 'netzpolitik@schleuder.digitale-gesellschaft.ch', lookup: 'netzpolitik@schleuder.digitale-gesellschaft.ch'});
		...
		contacts.push({label: 'asyl.ch-Newsletter', lookup: 'zuerich@asyl.ch'});
